...
#define CUSTOM_LIST_CLASS( klass )                                                                 \
	( G_TYPE_CHECK_CLASS_CAST( ( klass ), CUSTOM_TYPE_LIST, CustomListClass ) )
...
#define CUSTOM_LIST_GET_CLASS( obj )                                                               \
	( G_TYPE_INSTANCE_GET_CLASS( ( obj ), CUSTOM_TYPE_LIST, CustomListClass ) )

/* The data columns that we export via the tree model interface */

enum
{
	CUSTOM_LIST_COL_ACTIVE = 0,
	CUSTOM_LIST_COL_MUTED,
	CUSTOM_LIST_COL_FREQUENCY,
	CUSTOM_LIST_COL_NAME,
	CUSTOM_LIST_COL_LAST_ACTIVE,
